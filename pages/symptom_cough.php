...
<script>
    ...
    function myFunction(maCoord) {
        ...
        document.getElementById("contFichier2").value ="43"+ ","+
        document.getElementById("slider2").value + "," + document.forms["form_answers"].elements["answer"].value + "," + document.forms["form_answers"].elements["answer2"].value + "," +
