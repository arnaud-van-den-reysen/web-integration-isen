...
<div class="container text-center">
        ...
        <form name="form_answers" id ="form_answers" action="" method="POST">
            ...
            <div>C. How many liters of water do you drink per day usually?
                <input type="range" min="0" max="10" value="5" id="slider3" oninput="slidervalue()">
                <p>Value: <span id="slider_value3"></span></p>
            </div>

            <div>D. How many liters of water do you drink per day now?
                <input type="range" min="0" max="10" value="5" id="slider4" oninput="slidervalue()">
                <p>Value: <span id="slider_value4"></span></p>
            </div>
